...
\afterpage{
    \begin{landscape}
        \tabela{Wpływ ilości sesji treningowych na poprawność detekcji \label{tab:training_emotiv}}
        {Opracowanie własne}
        {
            \begin{threeparttable}
                \begin{tabularx}{\linewidth}{r|X|X|X|X|X|X|X|X|X|X}
                    ...
                    \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{S} & \multicolumn{1}{c|}{NS} & \multicolumn{1}{c|}{S} & \multicolumn{1}{c|}{NS} & \multicolumn{1}{c|}{S} & \multicolumn{1}{c|}{NS} & \multicolumn{1}{c|}{S} & \multicolumn{1}{c|}{NS} & \multicolumn{1}{c|}{S} & \multicolumn{1}{c}{NS} \\ \hline
...
{Opracowanie własne}
{
    \begin{threeparttable}
        \begin{tabularx}{.95\linewidth}{r|X|X|X|X|X|X}
            ...
            \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{S} & \multicolumn{1}{c|}{NS} & \multicolumn{1}{c|}{S} & \multicolumn{1}{c|}{NS} & \multicolumn{1}{c|}{S} & \multicolumn{1}{c}{NS} \\ \hline
...
\tabela{Wpływ parametrów \textit{Threshold} oraz \textit{Command Focus Time} na poprawność detekcji komendy mentalnej \textit{uniesienie}\label{tab:parameter_up}}
{Opracowanie własne}
{
    \begin{threeparttable}
        \begin{tabularx}{.95\linewidth}{r|X|X|X|X|X|X}
